  ...
  >
    <defs>
      <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#004080" /> {/* dark blue */}
        <stop offset="100%" stopColor="#008080" /> {/* teal */}
      </linearGradient>

      <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#008080" />
        <stop offset="100%" stopColor="#20b2aa" /> {/* lighter teal */}
      </linearGradient>

      <linearGradient id="grad3" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#20b2aa" />
        <stop offset="100%" stopColor="#40e0d0" /> {/* bright teal */}
      </linearGradient>
      ...
      <linearGradient id="grad7" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="40%" stopColor="#004080" />
        <stop offset="100%" stopColor="#004080" />
      </linearGradient>
    </defs>
    ...
    <g transform="translate(330, 0)">
      <path
        d="M456.655 0.824219H438.954V95.2577H456.655V0.824219Z"
        transform="translate(-438.954, 0)"
        fill="url(#grad3)"
        fillOpacity="0.85"
      />
    </g>
